...
class Stats extends React.PureComponent {
  ...
  static navigationOptions = {
    ...
    header: props => (
      <Header
        icoName={'cross_ico'}
        onButtonPress={() => self.props.navigation.goBack()}
        tabName={'Stats Exo Screen'}
        ...
        <View style={{borderWidth: 0, flex: 1, marginTop: 80, marginLeft: 5}}>
          ...
          <View style={{flex: 1, flexDirection: 'row'}}>
            <View style={{height: 25, width: 120, borderRightWidth: 1}}>
              <Text style={{textAlign: 'auto', fontSize: 20}}>jj/mm/aa</Text>
            </View>
            <View style={{height: 25, width: 120, borderRightWidth: 1}}>
              <Text style={{textAlign: 'auto', fontSize: 20}}>poids</Text>
            </View>
            <View style={{height: 25, width: 110}}>
              <Text style={{textAlign: 'auto', fontSize: 20}}>reps</Text>
            </View>
          </View>
        </View>
      </View>
